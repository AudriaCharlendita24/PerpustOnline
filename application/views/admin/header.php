  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="<?php echo base_url(); ?>assets/image/odyy.png" style="width: 130px ">
        </div>
        <div class="sidebar-brand-text " style="font-family: 'Roboto Slab', serif;">logo<sup></sup></div>
      </a>
    ...
    <?php $uriMethod_name=$this->router->fetch_method(); ?>
      ...
      <li <?php 
        ...
        <i class="fas fa-home" style="margin-right: 9%"></i>
      ...
      <li <?php 
        ...
        <a class="nav-link"  href="<?php echo base_url().'admin/buku'; ?>">
          <i class="fas fa-server" style="margin-right: 10%"></i>
          <span>Buku</span></a>
      </li>
       ...
       <li <?php 
        ...
        <a class="nav-link"  href="<?php echo base_url().'admin/kategori'; ?>">
         <i class="fas fa-tags" style="margin-right: 8%"></i>
      ...
      <li <?php 
        ...
        <a class="nav-link" href="<?php echo base_url().'admin/anggota'; ?>">
          <i class="fas fa-user" style="margin-right: 10%"></i>
          <span>Anggota</span></a>
      </li>
